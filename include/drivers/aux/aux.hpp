...
namespace AUX
{
    ...
    extern reg32_ptr_t IRQ_ADDR_PTR;
    extern reg32_ptr_t ENABLES_ADDR_PTR;

    extern reg32_ptr_t MU_IO_REG_ADDR_PTR;
    extern reg32_ptr_t MU_IER_REG_ADDR_PTR;
    extern reg32_ptr_t MU_IIR_REG_ADDR_PTR;
    extern reg32_ptr_t MU_LCR_REG_ADDR_PTR;
    extern reg32_ptr_t MU_MCR_REG_ADDR_PTR;
    extern reg32_ptr_t MU_LSR_REG_ADDR_PTR;
    extern reg32_ptr_t MU_MSR_REG_ADDR_PTR;
    extern reg32_ptr_t MU_SCRATCH_ADDR_PTR;
    extern reg32_ptr_t MU_CNTL_REG_ADDR_PTR;
    extern reg32_ptr_t MU_STAT_REG_ADDR_PTR;
    extern reg32_ptr_t MU_BAUD_REG_ADDR_PTR;

    extern reg32_ptr_t SPI0_CNTL0_REG_ADDR_PTR;
    extern reg32_ptr_t SPI0_CNTL1_REG_ADDR_PTR;
    extern reg32_ptr_t SPI0_STAT_REG_ADDR_PTR;
    extern reg32_ptr_t SPI0_IO_REG_ADDR_PTR;
    extern reg32_ptr_t SPI0_PEEK_REG_ADDR_PTR;

    extern reg32_ptr_t SPI1_CNTL0_REG_ADDR_PTR;
    extern reg32_ptr_t SPI1_CNTL1_REG_ADDR_PTR;
    extern reg32_ptr_t SPI1_STAT_REG_ADDR_PTR;
    extern reg32_ptr_t SPI1_IO_REG_ADDR_PTR;
    extern reg32_ptr_t SPI1_PEEK_REG_ADDR_PTR;
